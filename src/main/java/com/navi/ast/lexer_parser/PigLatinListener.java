...
public interface PigLatinListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterStructBooleanFieldSemicolon(PigLatinParser.StructBooleanFieldSemicolonContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StructBooleanFieldSemicolon}
	 * labeled alternative in {@link PigLatinParser#structFieldWithSemicolon}.
	 * @param ctx the parse tree
	 */
	void exitStructBooleanFieldSemicolon(PigLatinParser.StructBooleanFieldSemicolonContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterStructBooleanFieldComma(PigLatinParser.StructBooleanFieldCommaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StructBooleanFieldComma}
	 * labeled alternative in {@link PigLatinParser#structFieldWithComma}.
	 * @param ctx the parse tree
	 */
	void exitStructBooleanFieldComma(PigLatinParser.StructBooleanFieldCommaContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterBooleanVarDeclaration(PigLatinParser.BooleanVarDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code BooleanVarDeclaration}
	 * labeled alternative in {@link PigLatinParser#variableDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitBooleanVarDeclaration(PigLatinParser.BooleanVarDeclarationContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PigLatinParser#booleanLiteral}.
	 * @param ctx the parse tree
	 */
	void enterBooleanLiteral(PigLatinParser.BooleanLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link PigLatinParser#booleanLiteral}.
	 * @param ctx the parse tree
	 */
	void exitBooleanLiteral(PigLatinParser.BooleanLiteralContext ctx);
	/**

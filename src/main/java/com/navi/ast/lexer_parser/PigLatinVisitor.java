...
public interface PigLatinVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitStructBooleanFieldSemicolon(PigLatinParser.StructBooleanFieldSemicolonContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStructBooleanFieldComma(PigLatinParser.StructBooleanFieldCommaContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBooleanVarDeclaration(PigLatinParser.BooleanVarDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PigLatinParser#booleanLiteral}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBooleanLiteral(PigLatinParser.BooleanLiteralContext ctx);
	/**
